...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ mediaId, manifestName }) => {
    ...
    return (
        <div ref={containerRef} className="relative flex justify-center w-full overflow-hidden bg-black pb-16" onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
            <canvas
                ref={canvasRef}
